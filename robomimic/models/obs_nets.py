...
from robomimic.models.base_nets import MLP, Module, RNN_Base, Sequential
...
class ObservationEncoder(Module):
    ...
    def register_obs_key(
        ...
        randomizers: nn.Module | list[nn.Module] | None = None,
        share_net_from: str | None = None,
    ):
        """
...
class ObservationGroupEncoder(Module):
    ...
    def __init__(
        self,
        observation_group_shapes: OrderedDict[str, OrderedDict],
        feature_activation: type[nn.Module] | None = nn.ReLU,
        encoder_kwargs: dict | None = None,
    ):
        """
...
class RNN_MIMO_MLP(Module):
    ...
    def output_shape(self, input_shape):
        ...
        TensorUtils.assert_size_at_dim(
            input_shape, size=T, dim=0, msg="RNN_MIMO_MLP: input_shape inconsistent in temporal dimension"
        )
