...
def key_is_obs_modality(key: str, obs_modality: str) -> bool:
    """
...
def process_obs(obs: T, obs_modality: str | None = None, obs_key: str | None = None) -> T:
    """
...
def normalize_dict(dict: dict[str, T], normalization_stats: dict[str, dict[str, Sequence[T]]]):
    """
...
def unnormalize_dict(dict, normalization_stats: dict[str, dict[str, T]]):
    """
