...
import robomimic.tasks.mdp as mdp
...
class ObservationsCfg:
    ...
    @configclass
    class ImitationCfg(ObsGroup):
        robot0_eef_pos = ObsTerm(
            func=mdp.body_pos_b,
            params={"asset_cfg": SceneEntityCfg("robot", body_names="panda_hand")},
        )
        robot0_eef_quat = ObsTerm(
            func=mdp.body_quat_b,
            params={"asset_cfg": SceneEntityCfg("robot", body_names="panda_hand")},
        )
        robot0_gripper_qpos = ObsTerm(
    ...
    # observation groups
    imitation: ImitationCfg = ImitationCfg()
